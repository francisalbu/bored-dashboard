...
// TRANSFERS - Each transfer type as separate experience
export const getMockTransfers = (): ExperienceDetails[] => [
  ...
  {
    id: 'exp-trans-02',
    title: 'City Center Drop-off (Van)',
    category: 'Transfers',
    status: 'Active',
    units: [{
      id: 'u-trans-02',
...
// DINING/TABLES - Each table/dining experience as separate
export const getMockDining = (): ExperienceDetails[] => [
  {
    id: 'exp-dining-01',
    title: 'Terrace Table for 2',
    category: 'Dining',
    status: 'Active',
    units: [{
      id: 'u-table-01',
  ...
  {
    id: 'exp-dining-05',
    title: 'Wine Cellar Private Tasting',
    category: 'Dining',
    status: 'Active',
    units: [{
      id: 'u-table-05',
  ...
  {
    id: 'exp-dining-06',
    title: 'Beach BBQ Setup (up to 10)',
    category: 'Dining',
    status: 'Active',
    units: [{
      id: 'u-table-06',
