/**
 * Creates the user patricia.vieira and links them to the Homing hotel.
 *
 * Usage:
 *   node scripts/create-patricia-vieira.mjs
 */
...
const USER_EMAIL    = 'patricia.vieira@boredtourist.com';
const USER_PASSWORD = 'homing123';
const USER_NAME     = 'Patrícia Vieira';
